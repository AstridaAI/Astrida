/**
 * ------------------------------------------------------------
 * Astrida: Reinforcement Learning, Vision, Personality, Emotional States, and Plugin System.
 * ASTRIDA.xyz
...
kg.addRelation("Astrida", "createdBy", "JavaScript");
kg.addRelation("Astrida", "goal", "Become a functioning android");
kg.addRelation("JavaScript", "is", "a versatile language");

console.log("Knowledge Query:", kg.query("Astrida", "goal"));
