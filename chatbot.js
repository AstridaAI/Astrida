...
function generateResponse(userMessage) {
    ...
    if (lowerCaseMessage.includes('hello') || lowerCaseMessage.includes('hi')){
        ...
        const nameReplies = [
            "My name is Astridia, what about you?",
            "I'm just Astridia, and I'm here for you!",
            "I’m Astridia, your digital buddy. What about you?",
            "They call me Astridia, but I prefer 'friend'. What can I help you with today?",
            "I'm Astridia, at your service! What’s on your mind?"
        ];
    ...
    // Personal and emotional responses
        ...
        return "I'm Astridia your friendly AI buddy, here to chat, listen, and share moments with you. 😊";
    ...
    // Boundary for inappropriate questions
        ...
        return "Please! DON'T TALK TO ME LIKE THAT! :(";
    }
